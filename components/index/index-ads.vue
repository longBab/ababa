<template>
	<view>
		<view class="home_swiper">
			<swiper style="height: 280rpx;border-radius: 8px;overflow: hidden;" class=" ad-swiper bg-white" indicator-dots="true" indicator-color="rgba(228,228,228,1)"
...
<script>
	...
	export default {
		...
		data() {
			return {
				banner: [{
						url: 'https://i.ibb.co/5Wnhmf1/28-2x.png'
					},
					// {
