<template>
	<view>
		...
		<scroll-view @scrolltoupper="onPullDownRefresh" upper-threshold="-100" :style="'height:' + winHeight + 'px'"
            ...
            <Empty description="您还没有地址信息" v-if="addressList.length <= 0"></Empty>
		</scroll-view>
		<navigator url="/pages/insert/insert" class="safe-area insert-address-view theme-color self-adaption">+新增地址
		</navigator>
	</view>
</template>
