            ...
            <view class="commodity-name-price-detail" v-if="deliveryAndSelfTaking && selfOutActiveIndex == 1">
                ...
                <view class="commodity-totalnum-price">
                    ...
                    <view class="commodity-price">
                        <text v-if="deliveryAndSelfTaking.isReducedDeliveryPrice" class="fullPriceReductionClass">￥{{
                            deliveryAndSelfTaking.reducedDeliveryTotalPrice }}</text>
        ...
        <uni-popup ref="pwdPopup" type="center" :mask-click="false">
            <view class="pwd-popup-content">
                <view class="flex_between content_box">
                    <view></view>
                    <view>输入支付密码</view>
                    <view class="close-icon" @tap="balancePayFail">×</view>
                </view>
                ...
                <view class="content_box" style="padding: 0 0;">
                    ...
                    <view class="theme-color password_dialog_forget_pwd" @tap.stop.prevent="forgetThePassword">忘记密码
                    </view>
                </view>
                // #endif
                ...
                <view class="content_box" style="padding: 0 16px;">
                    ...
                    <input class="password_dialog_input_control" password type="number" :focus="payFocus"
                        ...
                        :adjust-position="adjustPosition" cursor-spacing="100" :auto-focus="payFocus"
                        inputmode="numeric" />
                </view>
                // #endif
            </view>
...
export default {
    ...
    methods: {
        ...
        radioChangeAddress(e) {
            console.log(e);
            var that = this;
            var paymentModeIndex = parseInt(e.detail.value);
        ...
        choosePayModeTap() {
            ...
            let actualPrice = !this.orderDetail.fullPriceReductionIsHidden ?
        ...
        updateIsRequestWxNotify() {
            https.request('/rest/member/updateIsRequestWxNotify').then((result) => {
                if (result.success) {
                    console.log('修改用户的是否需要请求授权服务通知状态为否成��');
                }
            });
        },
