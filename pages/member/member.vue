					...
					<view class="flex_between">
						<view class="member-info">
							...
							<view class="nickname-vipEndTime">
                                ...
                                <!-- ID：{{ data.vipNo }} -->
								<view class="no-vipno flex_start"></view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getUserInfo: function(e) {
				https.request('/rest/member/getLoginMemberInfo', {}).then((result) => {
					if (result.success) {
						...
						this.isVipImages = this.isVipImages
					}
				});
			},
			...
			bindVipRecharge() {
				uni.navigateTo({
					url: '/pages/member/memberBenefits'
				});
			}
		}
	};
