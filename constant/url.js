...
const baseUrl2 = 'https://buyer-api.pickmall.cn/buyer/other/pageData/getIndex?clientType=H5';
export default {
	baseUrl: baseUrl,
	...
	// 测试
	test: baseUrl + 'app/notepad.listNotepad', // 查询投诉
	

	queryRoom: baseUrl + 'app/room.queryRooms', //查询业主房间
	...
	// 业主认证
	updataOwner: baseUrl + "app/room.updateRoomOwner",
	...
	updateMemberInfo: '/api/member/update'
}
